...
public class AddressBookMainUC5 {
	...
	public static void editContact(Scanner sc, AddressBookMainUC5 addressBook) {
		Map<String, Object> contacts = addressBook.getContacts();
	...
	public static void deleteContact(Scanner sc, AddressBookMainUC5 addressBook) {
		Map<String, Object> contacts = addressBook.getContacts();
		String input = "";
		System.out.println("Enter the firstName:");
		input += sc.next().toLowerCase().trim();
	...
	public static void bulkAddContacts(Scanner sc, AddressBookMainUC5 addressBook) {
